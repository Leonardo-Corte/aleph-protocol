...
import { Vocabulary, isWellFormedKey, namespaceOf } from "../src/core/vocabulary.ts";
import { publicKeyFromVerificationMethod } from "../src/core/resolver.ts";
import { createNode } from "../src/node/node.ts";
import { createRegistry } from "../src/registry/registry.ts";
import { resolve } from "../src/agent/client.ts";
